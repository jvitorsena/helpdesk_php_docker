...
--
-- Host: db
-- Tempo de geração: 10-Jun-2022 às 21:49
...
(3, 'aaaaa', 'asdas', 1),
(4, 'Teste pelo formulario', 'descricao pelo formulario', 1),
(5, 'teste desenvolvimento', 'teste desenvolvimento', 2),
(6, 'Consultoria', 'Teste de consultoria', 5);
...
--
ALTER TABLE `tbchamados`
  MODIFY `codigo_chamado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
